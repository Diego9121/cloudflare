    ...
    <AdminProtected>
      ...
      <header className="bg-charcoal text-gold py-4 px-6 shadow-lg">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold">Gestionar Módulos y Subcategorías</h1>
          <div className="flex gap-4">
            <Link href="/admin/dashboard" className="text-gold-light hover:text-white">← Dashboard</Link>
            <Link href="/admin/productos" className="text-gold-light hover:text-white">Productos</Link>
          </div>
        </div>
      </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col items-center">
            ...
            <input
              ...
              className="hidden"
              id="modulo-image-upload"
            />
            <label htmlFor="modulo-image-upload" className="cursor-pointer text-gold hover:text-gold-dark text-sm font-medium">
